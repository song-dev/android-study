...
public class Phone {
    ...
    public void Telephony(XC_LoadPackage.LoadPackageParam loadPkgParam) {
        ...
        Log.e(TAG, "Telephony IMEI: " + SharedPref.getXValue("IMEI"));
        Log.e(TAG, "Telephony networkType: " + SharedPref.getXValue("networkType"));

        String TelePhone = "android.telephony.TelephonyManager";
        try {
            XposedHelpers.findAndHookMethod("android.telephony.TelephonyManager", loadPkgParam.classLoader, "getDeviceId", XC_MethodReplacement.returnConstant("test"));
            XposedHelpers.findAndHookMethod("com.android.internal.telephony.PhoneSubInfo", loadPkgParam.classLoader, "getDeviceId", XC_MethodReplacement.returnConstant("test"));

            if (Build.VERSION.SDK_INT < 22) {
                XposedHelpers.findAndHookMethod("com.android.internal.telephony.gsm.GSMPhone", loadPkgParam.classLoader, "getDeviceId", XC_MethodReplacement.returnConstant("test"));
                XposedHelpers.findAndHookMethod("com.android.internal.telephony.PhoneProxy", loadPkgParam.classLoader, "getDeviceId", XC_MethodReplacement.returnConstant("test"));
            }
        } catch (Exception ex) {
